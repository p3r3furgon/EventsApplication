...
{
    public record UpdateEventCommand(Guid Id, string? Title, string? Description, DateTime? DateTime, 
        string? Place, string? Category, int? MaxParticipantNumber, IFormFile? Image, string? MessageTitle, string? MessageDescription) 
